...
def to_device(data, device):
    ...
    # SS
    if len(data) == 10:
        (ids, raw_texts, speakers, texts, src_lens, max_src_len, mels, mel_lens, max_mel_len, ref_infos) = data
        ...
        return (ids, raw_texts, speakers, texts, src_lens, max_src_len, mels, mel_lens, max_mel_len, ref_infos)
...
def log(logger, step=None, losses=None, fig=None, audio=None, sampling_rate=22050, tag=""):
    ...
    if losses is not None:
        ...
        logger.add_scalar("Loss/D_t_loss", losses[7], step)
        logger.add_scalar("Loss/cls_loss", losses[8], step)
